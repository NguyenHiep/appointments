        ...
        <div class="row">
          <div class="col-md-8 col-lg-8 col-sm-8 col-xs-12">
            <div class="clearfix box-content">
              ...
              ?>
              <h2 style="text-transform: uppercase">Bài viết liên quan</h2>
              <div class="related-posts row clearfix">
                ...
                ?>
                  ...
                  <div class="mcare-news-box">
                    <div class="news-img">
                      <a href="<?php the_permalink()?>"><img src="<?php echo $thumbnail_url; ?>" class="img-responsive" alt="<?php the_title()?>">
                      </a>
                      <div class="post-meta">
                    ...
                    <div class="text-content"><?php echo get_content_export(get_the_excerpt(), 200);?></div>
                    <div class="foot-meta">
