...
?>
    <section class="mcare-news-wrap blog-page col3-page">
        <div class="container">
            <?php if (have_posts()) : ?>
                <h2 class="mcare-h2"><?php printf(__('Kết quả tìm kiếm: %s', 'appointments'),
                        '<span>' . get_search_query() . '</span>'); ?></h2>
            <?php else : ?>
                <h2 class="mcare-h2"><?php _e('Không tìm thấy', 'appointments'); ?></h2>
            <?php endif; ?>
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 look2">
                                    <div class="mcare-news-box">
                                        <div class="news-img">
                                            ...
                                            <div class="post-meta">
                                                <div class="post-date">
                                                    <a href="<?php the_permalink(); ?>"><?php echo date('j / M', strtotime($post->post_date)) ?><br>
                                                        <strong><?php echo date('Y', strtotime($post->post_date)) ?></strong>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
